        ...
        return (
            ...
            <div>
                ...
                <div className="description">
                    ...
                    {this.state.city === "Elbrus" ? <div><div className="foto"><img src={foto2} alt="Elbrus"></img></div><p className="descText">
                    ...
                    {this.state.city === "Chamonix-Mont-Blanc" ? <div><div className="foto"><img src={foto3} alt="Aiguille du Midi"></img></div><p className="descText">
                    ...
                    {this.state.city === "Saint Helens" ? <div><div className="foto"><img src={foto4} alt="Mount Saint Helens"></img></div><p className="descText">
