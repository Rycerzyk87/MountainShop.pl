                ...
                <div className="description">
                    ...
                    <br></br>THAMEL – turystyczna dzielnica pełna hoteli, restauracji i sklepów. Bez problemu zakupisz tu pamiątki, używane książki w różnych językach lub zjesz przysmaki z całego świata. Thamel bywa też hałaśliwy i męczący więc na każdym rogu można złapać rikszę lub taksówkę i uciec w spokojniejsze rejony Katmandu.<br></br>INDRA CHOWK –  jest to również dzielnica pełna sklepów, ale miejscowych. Na placu Indra Chowk krzyżuje się sześć ulic. Jest to raczej jeden duży uliczny targ, gdzie można kupić wszystko: od butów, przez pralki, aż do warzyw. Między ulicami pełnymi towarów znajdują się małe kapliczki. Warto odwiedzić, aby zrobić zakupy i zobaczyć codzienne życie miejscowych.<br></br>KATMANDU DURBAR SQUARE – to plac znajdujący się przed starym pałacem królewskim byłego Królestwa Katmandu. Jest jednym z trzech takich placów w Dolinie Katmandu, które są wpisane na listę światowego dziedzictwa UNESCO. Na środku znajduje się pałac królewski, który przekształcony został w muzeum. Oprócz pałacu znajdziemy tu strzeliste pagody, posągi i wiele innych miejsc kultu zarówno hinduistów, jak i buddystów. Wstęp na plac kosztuje 750 NPR (25 PLN), bilet jest jednodniowy, jednak na podstawie biletu można wyrobić sobie przepustkę, upoważniającą do wchodzenia na teren placu na okres ważności wizy (wyrabia się w biurze na terenie Durbaru, potrzebne jedno zdjęcie paszportowe).
                        ...
                        <div className="iframe">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56516.31625953488!2d85.29111306240796!3d27.708955944363908!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb198a307baabf%3A0xb5137c1bf18db1ea!2sKatmandu%2044600%2C%20Nepal!5e0!3m2!1spl!2spl!4v1570037800385!5m2!1spl!2spl" style={{ width: "90%", height: "60vh", frameborder: "0", }} title="elbrus"></iframe></div></div> : null}
                    {this.state.city === "Elbrus" ? <div><div className="foto"><div className="logoOffer"></div><img src={foto2} alt="Elbrus"></img></div><p className="descText">
                        ...
                        <div className="iframe">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11605.180434213202!2d42.43657532790493!3d43.34993731612276!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40590ad75c4e757f%3A0x93b32f99989061ef!2sElbrus!5e0!3m2!1spl!2spl!4v1570037026868!5m2!1spl!2spl" style={{ width: "90%", height: "60vh", frameborder: "0", }} title="elbrus"></iframe></div></div> : null}
                    {this.state.city === "Chamonix-Mont-Blanc" ? <div><div className="foto"><div className="logoOffer"></div><img src={foto3} alt="Aiguille du Midi"></img></div><p className="descText">
                        ...
                        <div className="iframe">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d355514.7337504127!2d6.868650517365542!3d45.88213517831692!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47894c062dfe2ee7%3A0x408ab2ae4baa380!2s74400%20Chamonix-Mont-Blanc%2C%20Francja!5e0!3m2!1spl!2spl!4v1570037976792!5m2!1spl!2spl" style={{ width: "90%", height: "60vh", frameborder: "0", }} title="elbrus"></iframe></div></div> : null}
                    {this.state.city === "Saint Helens" ? <div><div className="foto"><div className="logoOffer"></div><img src={foto4} alt="Mount Saint Helens"></img></div><p className="descText">
